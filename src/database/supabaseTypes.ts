// Can be downloaded from supabase dashboard `https://supabase.com/dashboard/project/vuuwxeernvorwhkogrih/api?page=tables-intro`
export type Json =
	| string
	| number
	| boolean
		...
		Views: {
			...
			get_vote_summary: {
				Row: {
					...
					winning_movie_name: string | null
				}
				Relationships: [
					{
						foreignKeyName: "fk_club_sessions_poll"
